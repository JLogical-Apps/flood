...
class DeltaStyleCardRenderer with IsTypedStyleRenderer<StyledCard> {
  @override
  Widget renderTyped(BuildContext context, StyledCard component) {
    ...
    final body = component.bodyText?.mapIfNonNull((text) => StyledText.body.subtle(text)) ?? component.body;
