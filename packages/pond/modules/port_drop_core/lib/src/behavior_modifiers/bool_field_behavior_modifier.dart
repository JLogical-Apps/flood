...
class BoolFieldBehaviorModifier extends PortGeneratorBehaviorModifier<FieldValueObjectProperty<bool?, dynamic>> {
  ...
  Map<String, PortField> getPortFieldByName(
    FieldValueObjectProperty<bool?, dynamic> behavior,
