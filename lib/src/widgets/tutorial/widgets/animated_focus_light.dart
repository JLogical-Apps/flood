...
class AnimatedFocusLightState extends State<AnimatedFocusLight> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _controller = AnimationController(
      vsync: this,
      duration:
          _targetFocus.focusAnimationDuration ?? widget.focusAnimationDuration ?? DEFAULT_FOCUS_ANIMATION_DURATION,
    );
    ...
    _controllerPulse = AnimationController(
      vsync: this,
      duration: widget.pulseAnimationDuration ?? DEFAULT_PULSE_ANIMATION_DURATION,
    );

    _tweenPulse =
        _createTweenAnimation(_targetFocus.pulseVariation ?? widget.pulseVariation ?? DEFAULT_PULSE_VARIATION);
