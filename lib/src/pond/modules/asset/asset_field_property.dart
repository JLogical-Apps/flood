...
class AssetFieldProperty<A extends Asset<T>, T> extends FieldProperty<String> {
  ...
  late ValueStream<T?> valueX = _assetX.switchMapWithValue(
      (asset) => asset?.model.valueX.mapWithValue((value) => value.getOrNull()) ?? Stream<T?>.empty().publishValue());
